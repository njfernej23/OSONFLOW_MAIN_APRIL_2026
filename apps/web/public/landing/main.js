...
const $ = (s, c) => (c || document).querySelector(s);
  ...
  function generateAiResponse(query) {
    ...
    if (/(price|plan|cost|pricing|tier)/.test(q)) return (find("k-2") || {}).content || "We offer flexible plans from free, including a Growth plan with shared workspace seats and voice channels for $20/mo.";
