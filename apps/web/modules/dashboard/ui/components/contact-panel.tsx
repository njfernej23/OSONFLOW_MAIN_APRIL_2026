            ...
            <div className="border-b px-4 pb-4 pt-4">
                <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1 pt-0.5">
                        <h4 className="truncate text-[14px] font-semibold leading-snug text-foreground">
                            {contactSession.name}
                        </h4>
            ...
            {contactSession.metadata && (
                ...
                >
                    {accordionSections.map((section) => (
                        ...
                        >
                            <AccordionTrigger className="flex w-full items-center gap-3 px-4 py-3 text-left text-[12px] font-medium text-foreground hover:no-underline hover:bg-muted/40 transition-colors">
                                ...
                                <div className="space-y-2">
                                    {section.items.map((item) => (
                                        ...
                                        >
                                            ...
                                            <span className={`text-right text-[11px] font-medium text-foreground ${item.className ?? ""}`}>
                                                {item.value}
                                            </span>
                                        </div>
                                    ))}
